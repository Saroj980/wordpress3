...
if (!class_exists('ReduxFramework_upload')) {
	...
	class ReduxFramework_upload extends ReduxFramework_extension_upload
	{
		...
		echo '<div class="mfn-upload-field">';
			...
			echo ' <a href="javascript:void(0);" data-choose="' . esc_attr__( 'Choose a File', 'cura' ) . '" data-update="' . esc_attr__( 'Select File', 'cura' ) . '" class="mfn-opts-upload" ' . esc_attr( $upload ) . '><span></span>' . esc_html__( 'Browse', 'cura' ) . '</a>';
			echo ' <a href="javascript:void(0);" class="mfn-opts-upload-remove" ' . esc_attr( $remove ) . '>' . esc_html__( 'Remove Upload', 'cura' ) . '</a>';
